...
import { dispatchMasteryEvidenceProjection } from "../../../../modules/mastery/application/dispatch-evidence-projection";
...
async function dispatch(request: Request): Promise<NextResponse> {
  try {
    ...
    const summary = await dispatchMasteryEvidenceProjection(createPandoInternalProjectionClient());
