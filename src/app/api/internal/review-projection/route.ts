...
import { dispatchReviewItemProjection } from "../../../../modules/review/application/dispatch-review-projection";
...
async function dispatch(request: Request): Promise<NextResponse> {
  try {
    ...
    const summary = await dispatchReviewItemProjection(createPandoInternalProjectionClient());
