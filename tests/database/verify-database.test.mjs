...
test("a fake successful gate runs the complete exact argv set and stops once", async (t) => {
  ...
  assert.deepEqual(commands[2], [
    ...
    "supabase/tests/database/013_phase2_focus_evidence_mastery.test.sql",
    "supabase/tests/database/014_phase3a_review_core.test.sql",
    "supabase/tests/database/015_phase3b_target_readiness.test.sql",
    "supabase/tests/database/016_phase4a_planning_persistence.test.sql",
    "supabase/tests/database/017_phase4a_planning_concurrency.test.sql",
    "supabase/tests/database/018_phase4a_learning_track_activity_admission.test.sql",
    "supabase/tests/database/019_phase4a_learning_track_activity_admission_concurrency.test.sql",
    "supabase/tests/database/020_phase4a_planning_projection_worker.test.sql",
    "supabase/tests/database/021_phase4a_planning_direct_producer_routing.test.sql",
    "supabase/tests/database/022_phase4a_private_coordinator_implementations.test.sql",
    "supabase/tests/database/023_phase4a_planning_completed_work.test.sql",
    ...
    "supabase/tests/database/026_phase4b_growth_plan_lifecycle.test.sql",
    "supabase/tests/database/027_phase4b_growth_plan_lifecycle_concurrency.test.sql",
    "supabase/tests/database/028_phase4b_growth_plan_capacity.test.sql",
    "supabase/tests/database/029_phase4b_growth_plan_capacity_concurrency.test.sql",
    "supabase/tests/database/030_phase4b_learning_track_lifecycle.test.sql",
    ...
    "supabase/tests/database/036_phase4b_manual_activity_admission.test.sql",
    "supabase/tests/database/037_phase4b_manual_activity_admission_concurrency.test.sql",
    "supabase/tests/database/038_phase4b_additional_learning_track_creation.test.sql",
    "supabase/tests/database/039_phase4b_additional_learning_track_creation_concurrency.test.sql",
    ...
    "supabase/tests/database/045_phase4b_learning_track_cadence_control.test.sql",
    "supabase/tests/database/046_phase4b_learning_track_cadence_control_concurrency.test.sql",
    "supabase/tests/database/047_phase4b_planning_cadence_v2_activation.test.sql",
    "supabase/tests/database/048_phase4b_growth_plan_replacement.test.sql",
    "supabase/tests/database/049_phase4b_growth_plan_replacement_concurrency.test.sql",
    "supabase/tests/database/050_phase4b_d4_interview_campaigns.test.sql",
    "supabase/tests/database/051_phase4b_d4_interview_campaigns_concurrency.test.sql",
    "supabase/tests/database/052_phase4b_d5_campaign_allocation_overrides.test.sql",
    "supabase/tests/database/053_phase4b_d5_campaign_allocation_overrides_concurrency.test.sql",
    "--local",
  ]);
