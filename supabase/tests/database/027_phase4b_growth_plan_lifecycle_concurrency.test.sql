...
insert into lifecycle_concurrency_setup values ('same-plan', pg_temp.initialize_growth_plan_fixture_v1(
...
insert into lifecycle_concurrency_setup values ('stale-plan', pg_temp.initialize_growth_plan_fixture_v1(
