-- Adapt the Targets-owned readiness blocker shape to Planning's privacy-minimized input contract.
-- Targets persists {code, ruleId, lower, upper}; Planning consumes only {code, ruleKey}.
